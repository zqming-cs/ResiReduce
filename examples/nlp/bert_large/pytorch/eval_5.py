...
def main():
    ...
    if args.do_train:
        ...
        # optimizer = hvd.DistributedOptimizer(optimizer, grace, named_parameters=model.named_parameters())
        optimizer = hvd.DistributedOptimizer(optimizer, communicator, named_parameters=model.named_parameters(),op=hvd.Adasum if args.use_adasum else hvd.Average)
    ...
    if args.do_train:
        ...
        if hvd.rank()==0:
            ...
            np.savetxt("/home/user/eurosys23/workspace/ACTopk/examples/convergence_eval/data/bert_005.txt", ans)  
...
def test_bert_model_parameters():
    parser = argparse.ArgumentParser()
